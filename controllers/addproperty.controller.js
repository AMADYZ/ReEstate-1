...
let createProp = async (req,res) => {
  ...
  properties1.create({username,title,location,locationgps,description,type,condition,bedrooms,bathrooms,area,urllocation,images,price});
...
//store the images in the public file
  ...
  //   const uploadPath = path.join(__dirname, '../public/images/', names[counter]);
  //   counter++;
